...
public class CohereChatApi {
	...
	public record ChatCompletionRequest(@JsonProperty("model") String model,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model) {
			this(model, messages, null, null, CitationOptions.ACCURATE, null, SafetyMode.CONTEXTUAL, null, null, 0.3,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature,
				boolean stream) {
			this(model, messages, null, null, CitationOptions.ACCURATE, null, SafetyMode.CONTEXTUAL, null, null,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, List<FunctionTool> tools,
			...
			this(model, messages, tools, null, CitationOptions.ACCURATE, null, SafetyMode.CONTEXTUAL, null, null, 0.75,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, Boolean stream) {
			this(null, messages, null, null, CitationOptions.ACCURATE, null, SafetyMode.CONTEXTUAL, null, null, 0.75,
	 ...
	 * @param content The contents of the message. Can be either a {@link MediaContent} or
	 ...
	 * document is either a string or document object with content and metadata.
	 *
	...
	public record ChatCompletion(@JsonProperty("id") String id,
			...
			@JsonProperty("message") ChatCompletionMessage message, @JsonProperty("logprobs") LogProbs logprobs,
